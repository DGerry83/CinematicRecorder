...
namespace CinematicRecorder.Core
{
    ...
    /// Called when SessionState.EnableGTAO changes.
    /// </summary>
    public static class GTAOManager
    {
        ...
        {
            bool shouldEnable = SessionState.EnableGTAO;
        ...
        /// <summary>
        /// Call at startup to sync with SessionState.
        /// </summary>
