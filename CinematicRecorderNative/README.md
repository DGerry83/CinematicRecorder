...
2. **NVIDIA NVENC SDK:**
   ...
   - Register for NVIDIA Developer Program (free) → Download "Video Codec SDK"  
   - Extract `Interface/nvEncodeAPI.h` to `NativePlugin/nvenc/nvEncodeAPI.h`

3. **FFmpeg (LGPL or GPL)**:
...
4. **Visual Studio 2022**: Install "Desktop development with C++" workload
